...
window.CASE_DATA = {
  en: {
    ...
    solution1: "The site had to serve two people arriving for opposite reasons, inside a month, built by one person. Every decision below follows from those two facts.",
    caption1: "Homepage — hero, statistics, services, featured jobs and news",
    caption2: "Recruitment — services, HR solutions, process, testimonials and FAQ",
    caption3: "HR Solutions — the service list and what the organisation brings to it",
    results1: "Delivered as design and an interactive prototype. The project did not go into development during the period I was responsible for it, so there are no production figures to report — the numbers below are the scope that was delivered.",
    stat1: "4",
    ...
    caption4: "Job Search — filter by role, location and type, on tablet and mobile"
  },
  ...
  th: {
    ...
    tools: "Figma",
    problem1: "เว็บเดียว ผู้ใช้สองกลุ่มที่ต้องการคนละอย่าง และมีเวลาหนึ่งเดือนให้ทั้งคู่รู้สึกว่าเว็บนี้ทำมาเพื่อเขา",
    problem2: "",
    process1: "โจทย์จากลูกค้าชัดอยู่แล้ว และด้วยเวลาหนึ่งเดือนโดยไม่มีคนอื่นในทีม จุดที่ได้ผลที่สุดคือโครงสร้าง ไม่ใช่การทดลอง — แยกผู้ใช้สองกลุ่มตั้งแต่ระดับ Navigation แล้วสร้าง Pattern กลางชุดเดียว ทั้ง Section Header, Service Card, Statistic Block และ CTA Band แล้วให้ทุกหน้าเดินจากชุดนั้น พร้อมส่งมอบ Interactive Prototype ไปด้วย เพราะโจทย์คือเรื่องทางเข้าอยู่ตรงไหน ซึ่งเป็นคำถามที่ภาพนิ่งตอบได้ไม่ดี",
    quote: "โจทย์คือเรื่องทางเข้า — ต้องกดตรงไหน ภาพนิ่งตอบคำถามนี้ได้ไม่ดี แต่ Prototype ตอบได้จบในรอบเดียว",
    solution1: "เว็บนี้ต้องรับใช้คนสองกลุ่มที่เข้ามาด้วยเหตุผลตรงข้ามกัน ภายในหนึ่งเดือน และสร้างโดยคนคนเดียว ทุกการตัดสินใจด้านล่างมาจากข้อเท็จจริงสองข้อนี้",
    caption1: "หน้าหลัก — Hero ตัวเลของค์กร บริการ ตำแหน่งงานเด่น และข่าวสาร",
    caption2: "Recruitment — บริการ HR Solutions ขั้นตอน คำรับรอง และคำถามที่พบบ่อย",
    caption3: "HR Solutions — รายการบริการ และสิ่งที่องค์กรมีให้",
    results1: "ส่งมอบเป็นงานออกแบบและ Interactive Prototype โปรเจกต์ไม่ได้เข้าสู่ขั้นพัฒนาในช่วงที่ผมรับผิดชอบ จึงไม่มีตัวเลขจากการใช้งานจริงให้รายงาน ตัวเลขด้านล่างคือขอบเขตงานที่ส่งมอบ",
    stat1: "4",
    ...
    caption4: "ค้นหางาน — กรองตามตำแหน่ง สถานที่ และประเภทงาน บนแท็บเล็ตและมือถือ"
  }
};
