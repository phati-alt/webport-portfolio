...
window.CASE_DATA = {
  en: {
    ...
    problem1: "The platform served the people furthest from the site, and almost no one else.",
    problem2: "",
    ...
    stat3: "+90%",
    stat3Label: "Component reusability",
    ...
    ut1Role: "Executives",
    ut1Need: "Read the project-wide picture well, and were served by it.",
    ut1Ok: "yes",
    ut2Role: "Engineers",
    ut2Need: "Needed the data that belonged to their own site work.",
    ut2Ok: "no",
    ut3Role: "Architects",
    ut3Need: "Could not filter down to the information that related to their own drawings.",
    ut3Ok: "no",
    ...
    reflect1Text: "A flexible structure that is easy to adjust, and cuts the cost of changing the system later.",
    reflect2Title: "Modular components",
    reflect2Text: "Components that compose and adjust on their own, without disturbing the structure around them.",
    reflect3Title: "Variables and theming",
    reflect3Text: "Managing variables, theme colour and component variants once the system is genuinely large.",
    reflect4Title: "Less time spent in handover",
    reflect4Text: "A design system that says the same thing to UI design, the product owner and the developers.",
    ...
    sol1Title: "Custom Dashboard",
    sol1Text: "People build their own view - adding, removing and arranging widgets around the work their role actually does.",
    sol2Title: "Preset Sharing",
    sol2Text: "Share a dashboard template with the team, so the data and settings match how the work is really run.",
    sol3Title: "Design System Rebuild",
    sol3Text: "Rebuilt on Shadcn UI and Tailwind CSS for flexibility, modular components and design tokens that hold.",
    sol4Title: "Dynamic Theming",
    sol4Text: "Runtime theming, per-user customisation, brand colour and dark or light, all through CSS variables.",
    ps1Title: "Assess",
    ps1Text: "Assess the problem and the existing design",
    ps2Title: "Decide",
    ps2Text: "Choose Shadcn + Tailwind",
    ps3Title: "Rebuild",
    ps3Text: "Build the new design system",
    ps4Title: "Tokenize",
    ps4Text: "Establish the design token system",
    ps5Title: "Ship",
    ps5Text: "Custom Dashboard delivered",
    bi1Name: "Ananda Development",
    bi1Type: "Mobile application",
    bi2Name: "Gulf Energy",
    bi2Type: "UX/UI",
    bi3Name: "CHPP",
    bi3Type: "Dashboard",
    stat4: "3",
    stat4Label: "Enterprise accounts closed",
  ...
  th: {
    ...
    tools: "Figma, Design Tokens, Shadcn UI, Tailwind CSS",
    problem1: "แพลตฟอร์มตอบโจทย์คนที่อยู่ไกลหน้างานที่สุด และแทบไม่ตอบโจทย์ใครอีกเลย",
    problem2: "",
    ...
    stat3: "+90%",
    stat3Label: "การนำ Component กลับมาใช้ซ้ำ",
    ...
    ut1Role: "ผู้บริหาร",
    ut1Need: "เข้าใจข้อมูลภาพรวมได้ดี",
    ut1Ok: "yes",
    ut2Role: "วิศวกร",
    ut2Need: "ต้องการข้อมูลเฉพาะหน้างาน",
    ut2Ok: "no",
    ut3Role: "สถาปนิก",
    ut3Need: "กรองข้อมูลที่เกี่ยวข้องกับงานตัวเองไม่ได้",
    ut3Ok: "no",
    ...
    testimonialRole: "Sitearound CM — Enterprise Division",
    reflect1Title: "พัฒนา Architecture ของ Design System",
    reflect1Text: "โครงสร้างยืดหยุ่นปรับแต่งง่าย ลดภาระในการแก้ไขระบบ",
    reflect2Title: "ออกแบบ Component แบบ Modular",
    reflect2Text: "UI Components ประกอบและปรับแต่งได้ ลดผลกระทบต่อโครงสร้างรวม",
    reflect3Title: "บริหาร Variables & Theme อย่างมืออาชีพ",
    reflect3Text: "เทคนิคขั้นสูงในการจัดการ Variables, Theme Color และ Component Variants ในระดับใหญ่",
    reflect4Title: "ลดเวลาทำงานร่วมกัน",
    reflect4Text: "Design System ที่สื่อสารตรงกันทั้ง UI Design, Product Owner และ Developer",
    team: "PO · Consultant, Frontend & Backend Dev",
    client: "Ananda · Gulf Energy · CHPP",
    ...
    sol1Title: "Custom Dashboard",
    sol1Text: "ให้ผู้ใช้สร้างมุมมองข้อมูลของตัวเองได้ เพิ่ม ลบ และจัดเรียง Widget ตามบทบาทหน้างาน",
    sol2Title: "Preset Sharing",
    sol2Text: "แชร์ Dashboard Template ให้ทีมได้ เพื่อให้ข้อมูลและการตั้งค่าสอดคล้องกับงานจริง",
    sol3Title: "Design System Rebuild",
    sol3Text: "รื้อสร้าง Design System ใหม่ด้วย Shadcn UI + Tailwind CSS เพื่อความยืดหยุ่น, Modular Components และ Design Tokens ที่แม่นยำ",
    sol4Title: "Dynamic Theming",
    sol4Text: "รองรับ Runtime Theming, Per-User Customization, Brand Color และ Dark/Light Theme ด้วยระบบ CSS Variables",
    ps1Title: "ประเมิน",
    ps1Text: "ประเมินปัญหาและ Design เดิม",
    ps2Title: "ตัดสินใจ",
    ps2Text: "เลือก Shadcn + Tailwind",
    ps3Title: "รื้อสร้าง",
    ps3Text: "สร้าง Design System ใหม่",
    ps4Title: "Tokenize",
    ps4Text: "สร้างระบบ Design Tokens",
    ps5Title: "ส่งมอบ",
    ps5Text: "Custom Dashboard สำเร็จ",
    bi1Name: "Ananda Development",
    bi1Type: "Mobile Application",
    bi2Name: "Gulf Energy",
    bi2Type: "UX/UI",
    ...
    bi3Type: "Dashboard",
    stat4: "3",
    stat4Label: "ดีล Enterprise ที่ปิดได้",
